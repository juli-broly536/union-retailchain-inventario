...
SELECT id_producto, nombre_producto, categoria FROM dbo.inventario_sucursal_norte
UNION
SELECT id_producto, nombre_producto, categoria FROM dbo.inventario_sucursal_sur;
...
SELECT id_producto, nombre_producto, categoria, stock FROM dbo.inventario_sucursal_norte
UNION ALL
SELECT id_producto, nombre_producto, categoria, stock FROM dbo.inventario_sucursal_sur;
